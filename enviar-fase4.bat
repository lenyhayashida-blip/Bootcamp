...
set LOG=%~dp0log-fase4.txt

for /f %%i in ('powershell -NoProfile -Command "Get-Date -Format yyyyMMdd-HHmmss"') do set TS=%%i
set BRANCH=feature/lh-consultoria-fase4-%TS%
...
echo.
echo === 4. Commit ===
git commit -m "Fase 4 - migracoes SQL do Supabase, RLS e dados iniciais" -m "Co-Authored-By: Claude Opus 5 <noreply@anthropic.com>" -m "Claude-Session: https://claude.ai/code/session_01WCeUixBZ9BawhUzMDzfR4H"
echo.
...
if defined PRURL (
  echo Abrindo o Pull Request da Fase 4 no navegador...
  start "" "%PRURL%"
) else (
